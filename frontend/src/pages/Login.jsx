          ...
          <div className="rounded-3xl border border-slate-200/80 bg-white p-10 shadow-xl shadow-slate-100 dark:border-slate-800 dark:bg-slate-900 dark:shadow-none transition-colors duration-200">
            ...
            <form className="mt-8 space-y-5" onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="inline-flex min-h-[46px] w-full items-center justify-center rounded-2xl bg-blue-600 px-4 py-3.5 text-sm font-semibold text-white shadow-lg shadow-blue-500/10 transition hover:bg-blue-700 active:scale-[0.99] disabled:cursor-not-allowed disabled:bg-blue-300 dark:disabled:bg-blue-800"
              >
            ...
            <p className="mt-8 text-center text-sm text-slate-500 dark:text-gray-400">
              ...
              <Link to="/register" className="inline-flex items-center gap-1 font-semibold text-blue-600 hover:text-blue-700 dark:text-blue-400 group">
                Create an account
